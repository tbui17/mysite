...
class ContactFormHandler {
	...
	public function process():void {
		...
		foreach ( $fields as $field ) {
			...
			if ( 'divi/contact-field' !== $field->blockName ) { // phpcs:ignore ET.Sniffs.ValidVariableName.UsedPropertyNotSnakeCase -- This is a property of the WP Core class.
				continue;
			}
      ...
      // Use pre-filtered field attributes if provided, otherwise use field attributes from storage.
		...
		$contact_form_info = array(
			'contact_form_id'        => $module_attrs['module']['advanced']['htmlAttributes']['desktop']['value']['id'] ?? 'et_pb_contact_form_' . $order_index,
